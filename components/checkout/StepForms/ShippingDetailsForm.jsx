      ...
      <div className="mb-4 border-b border-gray-50">
        ...
        {isAddingNewAddress && (
          <button
            ...
            className="my-2 w-full p-2 border border-primary rounded-md bg-primary text-white hover:bg-white hover:text-gray-900"
          >
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between py-4 space-y-6 md:space-y-0">
            <div>
              <label
                ...
                className="block font-medium text-gray-50"
              >
