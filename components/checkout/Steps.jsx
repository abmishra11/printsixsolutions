      ...
      >
        <li>
          <div className="-m-1">
            ...
            >
              Cart
              <span className="inline-flex items-center justify-center w-5 h-5 ml-2 font-bold bg-primary rounded-full text-white text-xs">
                {" "}
                {cartItems.length}{" "}
              </span>
            </a>
          ...
          return (
            <li key={i}>
              <div className="flex items-center">
                ...
                <div className="-m-1">
                  <p
                    className={`p-1 ml-1.5 text-sm font-medium text-gray-500 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 ${
