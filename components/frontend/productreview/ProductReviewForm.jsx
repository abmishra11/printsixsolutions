...
export default function ProductReviewForm() {
  return (
    <div className="bg-slate-700 py-16 my-8 rounded-xl"> 
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
          ...
          <div className="flex items-center justify-between mt-4">
            <h2 className="text-2xl text-primary mr-2 font-bold">Customer Review</h2>
            <Link href={"#"} className="bg-primary text-white py-2 px-4 rounded-lg">
              Add Review
            </Link>
          </div>
          <div className="flex items-center justify-between mt-4">
            <div className="flex items-start">
              <Image className="mr-4 rounded-lg" src={"/photo.jpg"} height={50} width={50}/>
              <div>
          ...
          <div className="flex items-center justify-between mt-4">
            <p className="text-gray-800">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
          </div>
      </div>
      <form
        id="reviewForm"
