...
export default function CategoryList({ category }) {
  return (
    <div className="container bg-white border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-700 text-slate-800 overflow-hidden">
      ...
      <div className="container bg-white dark:bg-slate-700 p-4">
