...
export default function CartProduct({ cartItem }) {
  ...
  return (
    <div className="grid grid-cols-12 gap-6 border-b border-slate-400 pb-3 font-semibold text-sm mb-4">
      ...
      <div className="md:col-span-6 col-span-12 flex items-center justify-between">
