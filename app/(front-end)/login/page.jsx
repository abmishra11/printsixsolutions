    ...
    <section className="min-h-screen flex items-center justify-center">
      <div className="container py-16">
        <div className="max-w-lg mx-auto rounded-lg shadow-2xl p-10 bg-gray-800 border-gray-700 overflow-hidden">
          ...
          <p className="text-white mb-6 text-sm">Login if you are a returning customer</p>
          <LoginForm />
          ...
          <p className="mt-4 text-white text-center">Don&apos;t have an account? <Link href={"/register"} className="text-primary">Register now</Link></p>
        </div>
      </div>
    </section>
  );
